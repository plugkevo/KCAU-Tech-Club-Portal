<?php
    ...
    $query = "SELECT bio FROM user_credentials WHERE no = ?";
    ...
    if(isset($_POST['updateRecords']))
            {
                ...
                $stmt = $conn->prepare("UPDATE user_credentials set bio =? WHERE no=?");
...
<body>
    ...
    <form action="edit_bio.php?user_id=$user_id" method="post">
        <div class="container">
            <div class="content">
